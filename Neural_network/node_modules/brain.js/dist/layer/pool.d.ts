import { Filter } from 'brain.js/src/layer/filter';
import { IKernelFunctionThis, IKernelMapRunShortcut, ISubKernelObject, KernelOutput } from 'gpu.js';
import { IConvolutionSettingsBase, IConvolutionConstantsBase } from 'brain.js/src/layer/convolution';
import { ILayer, ILayerSettings } from 'brain.js/src/layer/base-layer';
