import { FormattableData, InputOutputValue, INumberHash, ITrainingDatum } from 'brain.js/src/lookup';
...
import { IRNNHiddenLayer, IRNNOptions, IRNNStatus, IRNNTrainingOptions, RNN } from 'brain.js/src/recurrent/rnn';
