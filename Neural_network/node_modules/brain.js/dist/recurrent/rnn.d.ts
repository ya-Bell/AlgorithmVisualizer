import { Log } from 'brain.js/src/feed-forward';
import { INeuralNetworkTrainOptions } from 'brain.js/src/neural-network';
import { IDataFormatter, IDataFormatterJSON } from 'brain.js/src/utilities/data-formatter';
import { IMatrixJSON, Matrix } from 'brain.js/src/recurrent/matrix';
import { Equation } from 'brain.js/src/recurrent/matrix/equation';
import { RandomMatrix } from 'brain.js/src/recurrent/matrix/random-matrix';
import { IRNNDatum, Value } from 'brain.js/src/recurrent/rnn-data-types';
