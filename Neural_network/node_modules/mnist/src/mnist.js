...
// raw data
var raw = [
  require('mnist/src/digits/0.json').data,
  require('mnist/src/digits/1.json').data,
  require('mnist/src/digits/2.json').data,
  require('mnist/src/digits/3.json').data,
  require('mnist/src/digits/4.json').data,
  require('mnist/src/digits/5.json').data,
  require('mnist/src/digits/6.json').data,
  require('mnist/src/digits/7.json').data,
  require('mnist/src/digits/8.json').data,
  require('mnist/src/digits/9.json').data
];
